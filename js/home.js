...
$(".why-slider_list").slick({
    ...
    prevArrow:
        '<button class="slide-arrow prev-arrow"><img src="./image/arrow_circle_left.svg"></button>',
    nextArrow:
        '<button class="slide-arrow next-arrow"><img src="./image/arrow_circle_left.svg"></button>',
    responsive: [
        {
            breakpoint: 767,
            settings: {
